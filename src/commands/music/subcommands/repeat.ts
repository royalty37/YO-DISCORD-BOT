...
export const handleRepeatSubcommand = async (interaction: Interaction<ChatInputCommandInteraction>) => {
  ...
  // Set repeat mode
  interaction.client.distube.setRepeatMode(interaction.guildId, mode);
